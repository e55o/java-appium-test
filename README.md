...
After loading the project, you need to add these dependencies (I added them manually without the use of `pom.xml` file), here's the list.

![jar](https://user-images.githubusercontent.com/31523264/52806388-903fc400-3091-11e9-9d3d-d41e3f994093.png)
...
After running the test suite, check the Eclipse `console`, you should see it all passing.
...
The test performed should look like this:
![test](https://user-images.githubusercontent.com/31523264/52807329-ced67e00-3093-11e9-9372-2e7767af5b78.gif)
